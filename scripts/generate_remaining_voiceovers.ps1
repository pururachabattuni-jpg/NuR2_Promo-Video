...
$scenes = @(
  @{ Input = "work/nur2_scene7_half_system_narration.txt"; Output = "$OutDir/nur2_scene7_half_system_voiceover_openai_shimmer_fixed.wav" },
  @{ Input = "work/nur2_scene8_capture_recover_return_narration.txt"; Output = "$OutDir/nur2_scene8_capture_recover_return_voiceover_openai_shimmer_fixed.wav" },
  @{ Input = "work/nur2_scene9_nur2_narration.txt"; Output = "$OutDir/nur2_scene9_nur2_voiceover_openai_shimmer_fixed.wav" },
  @{ Input = "work/nur2_scene10_future_narration.txt"; Output = "$OutDir/nur2_scene10_future_voiceover_openai_shimmer_fixed.wav" }
)
