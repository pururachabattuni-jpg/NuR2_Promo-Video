...
$scenes = @(
  @{ Input = (Join-Path $NarrationDir "part2_scene6_narration.txt"); Output = "$OutDir/part2_scene6_voiceover_openai_shimmer.wav" },
  @{ Input = (Join-Path $NarrationDir "part2_scene7_narration.txt"); Output = "$OutDir/part2_scene7_voiceover_openai_shimmer.wav" },
  @{ Input = (Join-Path $NarrationDir "part2_scene8_narration.txt"); Output = "$OutDir/part2_scene8_voiceover_openai_shimmer.wav" },
  @{ Input = (Join-Path $NarrationDir "part2_scene9_narration.txt"); Output = "$OutDir/part2_scene9_voiceover_openai_shimmer.wav" },
  @{ Input = (Join-Path $NarrationDir "part2_scene10_narration.txt"); Output = "$OutDir/part2_scene10_voiceover_openai_shimmer.wav" },
  @{ Input = (Join-Path $NarrationDir "part2_scene11_narration.txt"); Output = "$OutDir/part2_scene11_voiceover_openai_shimmer.wav" }
)
...
foreach ($scene in $scenes) {
  ...
  $body = @{
    ...
    response_format = "wav"
    speed = 1.08
    instructions = "Sweet, professional adult female narration. Clear educational documentary tone, brisk but intelligible pacing, warm authority, no theatrical exaggeration."
