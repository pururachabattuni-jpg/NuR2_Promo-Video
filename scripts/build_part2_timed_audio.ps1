param(
  [string]$OutFile = "work/audio/part2_voiceover_timed.wav",
...
$clips = @(
  @{ File = "work/audio/part2_scene6_voiceover_openai_shimmer.wav"; Duration = 5.0 },
  @{ File = "work/audio/part2_scene7_voiceover_openai_shimmer.wav"; Duration = 5.0 },
  @{ File = "work/audio/part2_scene8_voiceover_openai_shimmer.wav"; Duration = 12.0 },
  @{ File = "work/audio/part2_scene9_voiceover_openai_shimmer.wav"; Duration = 23.0 },
  @{ File = "work/audio/part2_scene10_voiceover_openai_shimmer.wav"; Duration = 7.0 },
  @{ File = "work/audio/part2_scene11_voiceover_openai_shimmer.wav"; Duration = 10.0 }
)
